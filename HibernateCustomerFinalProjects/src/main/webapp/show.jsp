		...
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="http://www.fullstackjavadeveloper.in" class="navbar-brand"> User
					Customer Management Application </a>
			</div>
			<ul class="navbar-nav">
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th>Address</th>
						<th><a href="CustomerController?action=sortbyage">Contact Number</a></th>
						<th><a href="CustomerController?action=sortbyaccbalance">Account Balance</th>
						<th>Gender</th>
						<th>DOB</th>
						<th>Email</th>
						<th>Password</th>
				...
				<tbody>
					...
					<c:forEach var="customer" items="${customerList}">
						<tr>
							...
							<td><c:out value="${customer.custNumber}" /></td>
