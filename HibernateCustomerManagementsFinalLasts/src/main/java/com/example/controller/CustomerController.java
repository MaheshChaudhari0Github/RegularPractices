...
CustomerService customerService = new CustomerServiceImpl();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (action.equals("signup")&&custName!=null) {
			...
			Customer customer = new Customer(custName, custAddress, custNumber, custAccBalance, custDOB, custEmailId, custPassword);
			...
			Customer customer = new Customer(customername, custAddress, custNumber, custAccBalance, custDOB, custEmailId, custPassword);
			...
			request.setAttribute("CustomerList", customerService.getAllData().stream().sorted(Comparator.comparingDouble(Customer::getCustAccBalance)));
			redirect= SHOWDATA_PAGE;
